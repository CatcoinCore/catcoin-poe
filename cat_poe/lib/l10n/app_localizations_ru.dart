...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get navLeaders => 'Лидеры';

  @override
  String get navWallet => 'Кошелек';

  @override
  String get navRewards => 'Награды';
  ...
  @override
  String get dashboardTotalBalance => 'Общий баланс';

  @override
  String get dashboardCatoshi => 'катоши';
  ...
  @override
  String get dashboardStartMining => 'НАЧАТЬ МАЙНИНГ';
  ...
  @override
  String get boostersTitle => 'Бустеры';
  ...
  @override
  String get leaderboardRank => 'Ранг';

  @override
  String get leaderboardUser => 'Пользователь';

  @override
  String get leaderboardBalance => 'Баланс';
  ...
  @override
  String get walletTransactions => 'Транзакции';
  ...
  @override
  String get rewardsClaim => 'Получить';
  ...
  @override
  String get rewardsSocialTasks => 'Соц. задания';

  @override
  String get rewardsXTasks => 'Задания X';
  ...
  @override
  String get referralTitle => 'Мои рефералы';
  ...
  @override
  String get payoutHistoryTitle => 'История выплат';
  ...
  @override
  String get referralsTotal => 'Всего';

  @override
  String get referralsActiveCount => 'Активно';
  ...
  @override
  String get referralMilestoneBonusTitle => 'Бонус этапов за рефералов';

  @override
  String referralMilestoneBonusSubtitle(Object amount) {
    return 'Единовременная награда $amount катоши за приглашение';
  }

  @override
  String get referralBonusRewardAmountNote =>
      'Сумма награды настраивается на сервере и может быть обновлена администраторами.';

  @override
  String get referralBonusDetailAppTitle => 'Реферальный бонус';

  @override
  String get referralBonusStatusHeading => 'Статус реферального бонуса';

  @override
  String referralBonusRewardForReferrer(Object amount) {
    return 'Бонус вам (рефереру): $amount катоши';
  }

  @override
  String referralBonusRewardCredited(Object amount) {
    return 'Награда уже начислена ($amount катоши).';
  }

  @override
  String referralBonusConditionsProgress(Object met) {
    return '$met из 3 условий выполнено';
  }

  @override
  String referralBonusListAmount(Object amount) {
    return 'Реферальный бонус: $amount катоши';
  }

  @override
  String referralBonusDatesLine(Object joined, Object referred) {
    return 'Регистрация $joined · Реферал $referred';
  }

  @override
  String get referralBonusConditionMinedDays => 'Дни майнинга';

  @override
  String get referralBonusConditionMiningReward => 'Награда за майнинг (BASE)';

  @override
  String get referralBonusConditionGameReward => 'Игровые награды';

  @override
  String get referralBonusStatePending => 'Условия не выполнены';

  @override
  String get referralBonusStateEligible => 'Подходит для награды';

  @override
  String get referralBonusStateRewarded => 'Награда начислена';

  @override
  String get referralBonusStateUnderReview => 'На проверке у администратора';

  @override
  String get referralBonusStateRejected => 'Отклонено';
  ...
  @override
  String get payoutNoHistory => 'Нет истории выплат';
  ...
  @override
  String get gameNewGame => 'Новая игра';

  @override
  String get gameYouWin => 'Вы выиграли!';

  @override
  String get gameCpuWins => 'Компьютер выиграл';

  @override
  String get gameDraw => 'Ничья!';

  @override
  String get gameYourTurnX => 'Ваш ход (X)';

  @override
  String get gameYourTurnO => 'Ход CPU (O)';
  ...
  String gameSudokuSuccess(Object amount) {
    return 'Здорово! Вы решили судоку и заработали $amount катоши!';
  }
  ...
  String gameTictactoeSuccess(Object amount) {
    return 'Поздравляем! Вы заработали $amount катоши!';
  }

  @override
  String gamePuzzleSuccess(Object amount) {
    return 'Фантастика! Вы решили головоломку и заработали $amount катоши!';
  }
  ...
  @override
  String get languageGroupInternational => 'Международный';

  @override
  String get languageGroupIndian => 'Индия';
}
